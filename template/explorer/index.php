		...
		<div class="header-content">
			...
			<div class='header-middle'>
				<button class="btn btn-default" id='home' title='<?php echo $L['root_path'];?>'>
					<i class="font-icon icon-home"></i><?php echo $config['mportal'];?>
				</button>
		...
		<div class='frame-left'>
			...
			<div class="bottom_box">
				<div class="box_content">
					<a href="javascript:ui.path.list('*recycle*');" class="cell menuRecycleButton">
                        <i class="font-icon icon-trash"></i><span><?php echo $L['recycle'];?></span>
                    </a>
<!--					<a href="javascript:ui.path.list('*public*');" class="cell">-->
<!--                        <i class="font-icon icon-folder-open"></i><span>--><?php //echo $L['public_path'];?><!--</span>-->
<!--                    </a>-->
