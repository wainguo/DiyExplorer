...
//define('USER_PATH',   dirname(dirname(dirname(BASIC_PATH))) .'/u/');
define('USER_PATH',   dirname(dirname(dirname(BASIC_PATH))));
//define('PUBLIC_PATH',   DATA_PATH .'public/');     //公共目录
//define('PUBLIC_PATH',   DATA_PATH .'public/');     //公共目录
define('PUBLIC_PATH',   USER_PATH .'public/');     //公共目录
...
session_start();
//
$config['mportal'] = (isset($_SESSION['kod_user']))? $_SESSION['kod_user']['mportal']: '';
